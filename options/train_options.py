...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument("--model", type=str, default='DeepLab', help="available options : ")
        parser.add_argument("--device", type=str, default='cpu', help="which GPU to use")

        parser.add_argument("--snapshot-dir", type=str, default='checkpoints/logs', help="Where to save snapshots of the model.")
        parser.add_argument("--data-dir", type=str, default='dataset/GTSRB', help="Path to the directory containing the source dataset.")

        parser.add_argument("--size", nargs='+', type=int, default=[32,32], help="input image size.")

        parser.add_argument("--batch-size", type=int, default=1, help="input batch size.")
        parser.add_argument("--epochs", type=int, default=100, help="Number of training steps.")
        parser.add_argument("--epochs-stop", type=int, default=100, help="Number of training steps for early stopping.")
        ...
        parser.add_argument("--num-classes", type=int, default=43, help="Number of classes for cityscapes.")
        ...
        parser.add_argument("--wandb_id", type=str, default=None, help="Wandb run resume id (valid only if restore-from != None")
